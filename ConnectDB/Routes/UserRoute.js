...
import { FollowUser, Login, Logout, Register, UpdateCity, UploadProfilePic, getFollowers, getMyDetails } from '../../Controllers/UserControllers.js'
...
userRouter.put('/updatecity', VerifyToken, UpdateCity)